...
<div class="callout">
    ...
    <ul style="margin: 0.5rem 0 0 1.2rem; padding: 0;">
        <li>What <a href="{{ '/reference/glossary' | relative_url }}#fair">FAIR</a> data means in practice for this biodiversity use case.</li>
...
The result: estimates that are reproducible end-to-end and citable as a [D2KP]({{ '/reference/glossary' | relative_url }}#d2kp).
