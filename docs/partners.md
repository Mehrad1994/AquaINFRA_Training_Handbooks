...
<div class="sequence-navigation" style="display: flex; justify-content: space-between; margin-top: 4rem;">
    <a href="{{ '/vre' | relative_url }}" class="btn-seq btn-seq--prev">&larr; Previous: Intro Aqua VRE</a>
    <a href="{{ '/trainings' | relative_url }}" class="btn-seq btn-seq--next">Next Step: Use Case Material &rarr;</a>
</div>
