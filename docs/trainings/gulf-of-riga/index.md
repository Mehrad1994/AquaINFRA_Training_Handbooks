...
<div class="chapter-intro">
    <p>This use case tests whether the Gulf of Riga's water is really getting "darker" over time, using decades of Secchi-depth data and the DGA workflow (named after the Daugava river). Watch the workshop recording below, then use the chapters as a quick reference.</p>
</div>
