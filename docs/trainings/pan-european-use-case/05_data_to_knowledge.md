...
## The Toolkit
Select the package titled: **"Data to Knowledge Package for Specleaner: A toolkit for ensemble outlier detection and removal."** This package ensures all components are **FAIR** (Findable, Accessible, Interoperable, Reusable).
...
### 4. Reproducible Basis
Contains the complete toolbox, including scripts and tools hosted permanently on **GitHub** and **Zenodo**.
