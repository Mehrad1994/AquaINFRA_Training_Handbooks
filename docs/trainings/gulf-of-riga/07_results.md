...
1.  **Drivers**: What specific optical properties are changing?
2.  **Catchment Linkage**: How do land-use changes and runoff in the **Daugava River catchment** influence these marine changes?
3.  **Scalability**: Testing this workflow in other regions (North Sea, Mediterranean) to see if it applies elsewhere.
