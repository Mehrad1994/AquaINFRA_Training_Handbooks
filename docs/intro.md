---
layout: default
title: 1. Introduction to AquaINFRA
---
...
<div class="sequence-navigation" style="display: flex; justify-content: space-between; margin-top: 4rem;">
    <a href="{{ '/' | relative_url }}" class="btn-seq btn-seq--prev">&larr; Home</a>
    <a href="{{ '/vre' | relative_url }}" class="btn-seq btn-seq--next">Next Step: Intro Aqua VRE &rarr;</a>
</div>
