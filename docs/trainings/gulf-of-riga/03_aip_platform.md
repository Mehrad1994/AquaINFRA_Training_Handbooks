...
<div class="callout">
    ...
    <ul style="margin: 0.5rem 0 0 1.2rem; padding: 0;">
        <li>How to search the <a href="{{ '/reference/glossary' | relative_url }}#aip">AIP</a> for Gulf-of-Riga-relevant resources.</li>
...
- Browsing AIP needs no account — running anything you find still needs [Aqua Galaxy]({{ '/reference/prerequisites' | relative_url }}).
