...
<div class="chapter-intro">
    <p>This use case, developed at BOKU University, shows how to clean fragmented species-occurrence data with the specleanr package before species distribution modelling. Watch the workshop recording below, then use the chapters as a quick reference.</p>
</div>
