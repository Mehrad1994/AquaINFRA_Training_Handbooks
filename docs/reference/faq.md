...
<div class="sequence-navigation">
    <a href="{{ '/reference/prerequisites' | relative_url }}" class="btn-seq btn-seq--prev">← Prerequisites</a>
    <a href="{{ '/reference/quick-tasks' | relative_url }}" class="btn-seq btn-seq--next">Next: Quick-Task Index →</a>
</div>
