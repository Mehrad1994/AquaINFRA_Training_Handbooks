...
## Key Features
*   **Tool Repository**: Contains a set of specialized tools for marine and freshwater analysis.
*   **Workflow Management**: Users can import existing workflows (like the Gulf of Riga DGA workflow), run them on their own data, or modify them.
...
<div class="sequence-navigation">
    <a href="{{ base }}/trainings/gulf-of-riga/04_d2k_package" class="btn-seq btn-seq--prev">← Previous: D2K Package</a>
    <a href="{{ base }}/trainings/gulf-of-riga/06_workflow_concept" class="btn-seq btn-seq--next">Next Chapter: Workflow Concept →</a>
</div>
