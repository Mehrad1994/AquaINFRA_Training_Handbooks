...
<div class="sequence-navigation">
    <a href="{{ '/index' | relative_url }}" class="btn-seq btn-seq--prev">← Home</a>
    <a href="{{ '/reference/prerequisites' | relative_url }}" class="btn-seq btn-seq--next">Next: Prerequisites →</a>
</div>
