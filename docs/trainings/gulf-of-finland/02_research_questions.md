...
<div class="chapter-intro">
    <p>The specific research questions addressed by the workflows developed for this use case.</p>
</div>

There is currently a lack of research tools that integrate long-term catchment and river data with coastal sea observations, such as Earth Observation (EO) products, coastal water sampling, and FerryBox measurements. 
