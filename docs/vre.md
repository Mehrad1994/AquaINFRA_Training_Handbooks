...
<div class="sequence-navigation" style="display: flex; justify-content: space-between; margin-top: 4rem;">
    <a href="{{ '/intro' | relative_url }}" class="btn-seq btn-seq--prev">&larr; Previous: Intro AquaINFRA</a>
    <a href="{{ '/partners' | relative_url }}" class="btn-seq btn-seq--next">Next Step: Partners & Target &rarr;</a>
</div>
