...
<p style="color: var(--text-muted, #5a6b7a); font-size: 0.9rem;">📍 <a href="https://www.youtube.com/watch?v=v_0zyUVY--E&t=671s" target="_blank" rel="noopener">Jump to 11:11 → 13:12 in YouTube</a>.</p>

---

## Finding it

On the AIP, search for **"Data to Knowledge Package"** and select **"Data to Knowledge Package for Specleaner: A toolkit for ensemble outlier detection and removal."**

🔗 **Live D2KP**: <a href="https://aquainfra.dev.52north.org/result/zenodo:17175591" target="_blank" rel="noopener">Pan-European Biodiversity D2KP</a>

## The five sections

<div class="table-wrapper">
    <table>
        <thead><tr><th>Section</th><th>What it gives you</th><th>Best for</th></tr></thead>
        <tbody>
